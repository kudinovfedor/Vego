...
function bw_customize_register($wp_customize)
{
    ...
    // Section Vego
    $wp_customize->add_section('bw_vego', array(
        'title' => 'VEGO',
        'panel' => 'bw_theme_options',
        'priority' => 100,
    ));
    ...
    $wp_customize->add_setting('bw_vego_list_item-value-1', array('default' => ''));
    $wp_customize->add_setting('bw_vego_list_item-desc-1', array('default' => ''));
    $wp_customize->add_setting('bw_vego_list_item-value-2', array('default' => ''));
    $wp_customize->add_setting('bw_vego_list_item-desc-2', array('default' => ''));
    $wp_customize->add_setting('bw_vego_list_item-value-3', array('default' => ''));
    ...
    $wp_customize->add_control('bw_vego_live_title', array(
        ...
        'section' => 'bw_vego',
        'settings' => 'bw_vego_live_title',
        'type' => 'text',
        'input_attrs' => array(
            'placeholder' => 'Живи там где хочешь ты',
        ),
    ));

    $wp_customize->add_control('bw_vego_live_desc', array(
        'label' => 'Front, after projects map (description)',
        'section' => 'bw_vego',
        'settings' => 'bw_vego_live_desc',
        'type' => 'textarea',
        'input_attrs' => array(
            'placeholder' => 'Начинать свой день с чашки свежесваренного кофе у панорамного окна — бесценно.',
        ),
    ));

    $wp_customize->add_control('bw_vego_list_item-value-1', array(
        'label' => 'List Item Value 1',
        'section' => 'bw_vego',
        'settings' => 'bw_vego_list_item-value-1',
        'type' => 'text',
    ));

    $wp_customize->add_control('bw_vego_list_item-desc-1', array(
        'label' => 'List Item Desc 1',
        'section' => 'bw_vego',
        'settings' => 'bw_vego_list_item-desc-1',
        'type' => 'text',
    ));

    $wp_customize->add_control('bw_vego_list_item-value-2', array(
        'label' => 'List Item Value 2',
        'section' => 'bw_vego',
        'settings' => 'bw_vego_list_item-value-2',
        'type' => 'text',
    ));

    $wp_customize->add_control('bw_vego_list_item-desc-2', array(
        'label' => 'List Item Desc 2',
        'section' => 'bw_vego',
        'settings' => 'bw_vego_list_item-desc-2',
        'type' => 'text',
    ));

    $wp_customize->add_control('bw_vego_list_item-value-3', array(
        'label' => 'List Item Value 3',
        'section' => 'bw_vego',
        'settings' => 'bw_vego_list_item-value-3',
        'type' => 'text',
    ));

    $wp_customize->add_control('bw_vego_list_item-desc-3', array(
        'label' => 'List Item Desc 3',
        'section' => 'bw_vego',
        'settings' => 'bw_vego_list_item-desc-3',
        'type' => 'text',
    ));

    $wp_customize->add_control('bw_vego_list_item-value-4', array(
        'label' => 'List Item Value 4',
        'section' => 'bw_vego',
        'settings' => 'bw_vego_list_item-value-4',
        'type' => 'text',
    ));

    $wp_customize->add_control('bw_vego_list_item-desc-4', array(
        'label' => 'List Item Desc 4',
        'section' => 'bw_vego',
        'settings' => 'bw_vego_list_item-desc-4',
        'type' => 'text',
    ));
    ...
    $wp_customize->add_control('bw_additional_time_work', array(
        'label' => 'Time Work',
        'section' => 'bw_additional',
        'settings' => 'bw_additional_time_work',
        'type' => 'text',
    ));
